...
namespace ExpenseTrackerSystem1.Controllers
{
    public class CardDataController : ApiController
    {
        ...
        /// CURL: curl https://localhost:44338/api/CardData/FindCard/2
        /// </example>
        ...
        /// <param name="expense">JSON form data of a card</param>
        /// <returns>
        ...
        /// CURL: curl -d @card.json -H "Content-Type:application/json" https://localhost:44338/api/CardData/UpdateCard/6
        /// </example>
        ...
        /// FORM Data: Card JSON Object
        /// CURL: curl -d @card.json -H "Content-Type:application/json" https://localhost:44338/api/CardData/AddCard
        /// </example>
        ...
        /// CURL: curl -d "" https://localhost:44338/api/CardData/DeleteCard/9
        /// </example>
