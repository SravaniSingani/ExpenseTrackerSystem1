using ExpenseTrackerSystem1.Migrations;
using ExpenseTrackerSystem1.Models;
using System;
...
namespace ExpenseTrackerSystem1.Controllers
{
    public class CardController : Controller
    {
        ...
        static CardController()
        {
            ...
            client.BaseAddress = new Uri("https://localhost:44338/api/CardData/");
        ...
        /// <example>
        /// GET: Card/List
        /// curl: curl https://localhost:44338/api/CardData/ListCards
        /// </example>
        ...
        public ActionResult List()
        {
            ...
            // curl https://localhost:44338/api/CardData/ListCards
        ...
        /// <example>
        ///  GET: Card/Details/5
        ///  curl https://localhost:44338/api/CardData/FindCard/{id}
        /// </example>
        ...
        public ActionResult Create(Card card)
        {
            ...
            // curl: -d @expense.json -H "Content-Type:application/json" https://localhost:44393/api/ExpenseData/AddExpense
        ...
        /// </summary>
        /// <param name="id">Represents the selected card id</param>
        /// <param name="card"> represents the card object</param>
        /// <returns>
        /// Returns to a view to the details of the selected card
        /// </returns>
