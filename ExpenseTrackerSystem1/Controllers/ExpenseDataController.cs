...
namespace ExpenseTrackerSystem1.Controllers
{
    public class ExpenseDataController : ApiController
    {
        ...
        /// CURL: curl https://localhost:44338/api/ExpenseData/ListExpenses
        /// </example>
        ...
        /// CURL: curl https://localhost:44338/api/ExpenseData/FindExpense/2
        /// </example>
        ...
        /// CURL: curl -d @expense.json -H "Content-Type:application/json" https://localhost:44338/api/ExpenseData/UpdateExpense/3
        /// </example>
        ...
        /// FORM Data: Expense JSON Object
        /// CURL: curl -d @expense.json -H "Content-Type:application/json" https://localhost:44338/api/ExpenseData/AddExpense
        /// </example>
        ...
        /// CURL: curl -d "" https://localhost:44338/api/ExpenseData/DeleteExpense/12
        /// </example>
